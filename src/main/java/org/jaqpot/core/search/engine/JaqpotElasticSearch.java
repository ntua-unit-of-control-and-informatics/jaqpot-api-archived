...
//
//    private static final Logger LOG = Logger.getLogger(ElasticSearchEngine.class.getName());
//
//    @Inject
...
//    void init() {
//
//        elasticExistence = propertyManager.getProperty(PropertyManager.PropertyType.ELASTIC_EXISTS);
//
